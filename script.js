...
const FONCTIONS_INIT = [
  { code: 'PMC', nom: 'Protection masse câble', statut: 'supprimee', init: { matlab:1, check_conf:1, preconf:1, ci:1, preconfig:1, studio:1, mes_base:1, mes_cpu:0 } },
  { code: 'PW', nom: 'Protection wattmétrique', statut: 'en-cours', init: { matlab:1, check_conf:1, preconf:1, ci:0, preconfig:0, studio:0, mes_base:0, mes_cpu:0 } },
  ...
  { code: 'GEST_DJ', nom: 'Gestion disjoncteur', statut: 'presente', init: {} },
  { code: 'GEST_ICITN', nom: 'Gestion commutateur ICITN', statut: 'presente', init: {} },
  { code: 'GEST_SA1', nom: 'Gestion des sectionneurs SA1', statut: 'presente', init: {} },
  { code: 'GEST_SA2', nom: 'Gestion des sectionneurs SA2', statut: 'presente', init: {} },
  { code: 'GEST_SL', nom: 'Gestion des sectionneurs SL', statut: 'presente', init: {} },
  { code: 'GEST_STA', nom: 'Gestion des sectionneurs STA', statut: 'presente', init: {} },
  { code: 'GEST_STB', nom: 'Gestion des sectionneurs STB', statut: 'presente', init: {} },
  { code: 'GEST_STC', nom: 'Gestion des sectionneurs STC', statut: 'presente', init: {} },
  ...
  { code: 'Equip_tiers', nom: 'Interface protections tiers', statut: 'presente', init: {} },
...
function renderKPIs() {
  ...
  // Calcul dynamique des configurations avec statut "OUI"
  ...
  // Correction des filtres de comptage en cascade (sécurité de statut par défaut)
  document.getElementById('kpi-supprimees').textContent = FONCTIONS_INIT.filter(f => (state.fonctions[f.code]?.statut || f.statut) === 'supprimee').length;
  document.getElementById('kpi-encours').textContent = FONCTIONS_INIT.filter(f => (state.fonctions[f.code]?.statut || f.statut) === 'en-cours').length;
  
  // Rendu dynamique dans les ID ciblés
